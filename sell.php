...
<body background="bg.jpg">
	...
	<div class="container">
		<a href="/my/index.php" class="navbar-brand" id="text"> Online ElawaluKade</a>
...
<li class="dropdown">
	...
	<ul class="dropdown-menu" role="menu">
		...
		<li><a href="Vegitable.php">Vegitables</a></li>
...
<div class="postadd">
  ...
  <form action="mail_handlesell.php" method="post" name="from" class="form-box">
    		...
    		<p>Product Name</p>
    		<input type="text" name="pname" placeholder="Ex Carrot">
...
<br>
<br>
<footer class="text-center" id="footer">Powered By: ATI Badulla [Group Project-HNDIT 2K18]</footer>
<!-- <details model -->
