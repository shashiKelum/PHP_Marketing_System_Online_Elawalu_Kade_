...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Online ElawaluKade</title>
...
//                $mydiv .= '</div>';
        ...
        <div class="container-fluid" style="background-color: #18ecd1" >
            ...
            <div class="w3-topnav w3-green">
                <img width="175" height="120" src="images/logo.png"   alt="logo" style="margin-top:-6px;">
                <a href="index.php">Home</a>
                <a href="about.php">About Us</a>
                <a href="Vegitable.php">Buy Vegitables</a>
                       ...
                       <div class="row" style="margin-top: px">
                           <div class="col-xs-12 col-md-1"></div>
                            <div class="col-xs-12 col-md-6">
                                <h2 style="color: #10b213"><b> Online ElawaluKade</b></h2>
                                <p>Retail Point of Sale (POS) systems ,also known as POS software ,have come a long way
                                   from being bolt on application for cash registers. Today the cash register as the
                                   cornerstone piece of retail technology has been replaced by PCs, tables and mobile
                                   devices.
We offer cohesive software programs as a web
 store to large retail chains , and everything in between . this web based solution will able to handle any combination
 of checkout, inventory control (Stock) and customer management (CRM). This system will help you automate the point of
  sale, improve inventory tracking. Also this will enable more effective management of customer data to grow profits
   while decreasing store inefficiencies</p>
                            </div>
<!--                            ....................login...................-->
...
<img width="1317px" height="500px" src="images/cover.jpg"   alt="logo" style="margin right:-50%;">
            <!--JQUIERY................................................................. -->
            ...
            <div class="row" id="Index_register_form">
                ...
                <div class="col-md-6">
                    ...
                    <address>
                        <strong>BiFox Technology</strong><br>
                        ...
                        <abbr title="Telephone">P:</abbr> 0713100963
                    </address>
                    <address>
                        <strong><span class="glyphicon glyphicon-envelope"></span></strong><br>
                        <a href="mailto:sankaamazon@gmail.com">sankaamazon@gmail.com</a>
                    </address>
                    <a href="https://www.facebook.com/shashi.kelum?epa=SEARCH_BOX" target="_blank">
            ...
            <div class="row">
                ...
                <footer class="w3-container w3-teal w3-text-white-opacity">
                    <h5>Online ElawaluKade</h5>
                    <p>Powered By: ATI Badulla [Group Project-HNDIT 2K18]</p>
                </footer>
            </div>
        </div>
    </body>
